...
const IntegrationSettings = () => {
  ...
  const [settings, setSettings] = useState({
    ...
    email: {
      ...
      smtpUser: '',
      smtpPassword: '',
      fromEmail: 'noreply@sshu.edu',
      fromName: 'Smart Student Hub'
    },
    notifications: {
  ...
  const testEmailConnection = async () => {
    try {
      await apiService.post('/admin/settings/test-email', settings.email)
      alert('Email connection successful!')
    } catch (error) {
      alert('Email connection failed: ' + error.message)
    }
  }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('general', 'institutionCode', e.target.value)}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500"
                    />
                  </div>
                  <div>
